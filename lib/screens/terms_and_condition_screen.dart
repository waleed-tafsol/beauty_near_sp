    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Column(
          ...
          Text("Information We Collect",style: TextStyle(fontSize: 19.sp ,fontWeight: FontWeight.w500),),
            SizedBox(height: 5.h),
           Text("A- Personal Information",style: TextStyle(fontSize: 14.sp ,fontWeight: FontWeight.w400)),
            SizedBox(height: 5.h),
            Flexible(
              child:Text(
            ...
            Text( "B- Payment Information",style: TextStyle(fontSize: 14.sp ,fontWeight: FontWeight.w400)),
            SizedBox(height: 10.h),
            Flexible(
              child: Text(
            ...
            SizedBox(height: 10.h),
            Text( "C- Usage Data",style: TextStyle(fontSize: 14.sp ,fontWeight: FontWeight.w400)),
            SizedBox(height: 10.h),
            Flexible(
              child: Text(
